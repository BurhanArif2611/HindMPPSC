...
public class AnswerFragment extends Fragment {
    ...
    String Size = "";
    int Position = 0;
    /*ArrayList<Result> myList;*/ Result result;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        doneBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MockTestPrelimsActivity) getActivity()).Done_AllQuestions();
            }
        });
        firstLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                radioSecond.setTextColor(getActivity().getResources().getColor(R.color.primary_text));
                radioThird.setTextColor(getActivity().getResources().getColor(R.color.primary_text));
                radioFourth.setTextColor(getActivity().getResources().getColor(R.color.primary_text));
                //((MockTestPrelimsActivity) getActivity()).next_next((Position) + 1);
                ((MockTestPrelimsActivity) getActivity()).Answer_with_position((Position),radioFirst.getText().toString());
        ...
        secondLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                radioFirst.setTextColor(getActivity().getResources().getColor(R.color.primary_text));
                radioThird.setTextColor(getActivity().getResources().getColor(R.color.primary_text));
                radioFourth.setTextColor(getActivity().getResources().getColor(R.color.primary_text));
               // ((MockTestPrelimsActivity) getActivity()).next_next((Position) + 1);
                ((MockTestPrelimsActivity) getActivity()).Answer_with_position((Position),radioSecond.getText().toString());
        ...
        thirdLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                radioFourth.setTextColor(getActivity().getResources().getColor(R.color.primary_text));
               // ((MockTestPrelimsActivity) getActivity()).next_next((Position) + 1);
                ((MockTestPrelimsActivity) getActivity()).Answer_with_position((Position),radioThird.getText().toString());
        ...
        fourthLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                radioThird.setTextColor(getActivity().getResources().getColor(R.color.primary_text));
              //  ((MockTestPrelimsActivity) getActivity()).next_next((Position) + 1);
                ((MockTestPrelimsActivity) getActivity()).Answer_with_position((Position),radioFourth.getText().toString());
        ...
        switch (view.getId()) {
            case R.id.preview_btn:
                if ((Position) == 0) {
                    ...
                    ((MockTestPrelimsActivity) getActivity()).preview_next((Position) - 1);
                }
                break;
            case R.id.next_btn:
