...
public class PreviousLiveFragment extends Fragment {
    View view;
    ...
    private void GetLiveClassOnServer() {
        if (NetworkUtil.isNetworkAvailable(getActivity())) {
            ...
            ErrorMessage.E("privious_live_class>" + exam_id + ">>" + Subject_id + ">>" + SavedData.getIMEI_Number() + ">>" + UserProfileHelper.getInstance().getUserProfileModel().get(0).getUser_id());
            Call<ResponseBody> call = apiService.privious_live_class(exam_id, Subject_id, SavedData.getIMEI_Number(), UserProfileHelper.getInstance().getUserProfileModel().get(0).getUser_id());
                ...
                public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        try {
                            ...
                            ErrorMessage.E("privious_live_class" + object.toString());
                            ...
                            if (object.getString("status").equals("200")) {
                                ...
                                if (example.getResult().size() > 0) {
                                    ...
                                    LiveClass_Adapter firstR_v_adapter = new LiveClass_Adapter(getActivity(), example.getResult(), "Previous");
