...
public class TaskForMains_Adapter extends RecyclerView.Adapter<TaskForMains_Adapter.MyViewHolder> {
    View view;
    Context activity;
    List<Result> arrayList;


    public TaskForMains_Adapter(Context policyActivity, List<Result> arrayList) {
    ...
    @NonNull
    @Override
    public TaskForMains_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.live_class_subjects_list, parent, false);
        return new TaskForMains_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final TaskForMains_Adapter.MyViewHolder holder, int position) {
        ...
        holder.right_subject_img.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_task));
        holder.subject_img.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_task));
      /*  if (listCoupon.getSubscribe().equals("subscribe")) {
        ...
        holder.join_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("title", "Task For Mains");
