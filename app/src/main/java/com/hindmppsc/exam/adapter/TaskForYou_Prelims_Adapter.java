...
public class TaskForYou_Prelims_Adapter extends RecyclerView.Adapter<TaskForYou_Prelims_Adapter.MyViewHolder> {
    View view;
    Context activity;
    List<Result> arrayList;


    public TaskForYou_Prelims_Adapter(Context policyActivity, List<Result> arrayList) {
    ...
    @NonNull
    @Override
    public TaskForYou_Prelims_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.live_class_subjects_list, parent, false);
        return new TaskForYou_Prelims_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final TaskForYou_Prelims_Adapter.MyViewHolder holder, int position) {
      ...
      /*  if (listCoupon.getSubscribe().equals("subscribe")) {
        ...
        holder.join_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putSerializable("Alldata", listCoupon);
