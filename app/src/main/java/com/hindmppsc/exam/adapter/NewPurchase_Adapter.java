...
public class NewPurchase_Adapter extends RecyclerView.Adapter<NewPurchase_Adapter.MyViewHolder> {
    View view;
    Context activity;
    List<Result> arrayList;


    public NewPurchase_Adapter(Context policyActivity, List<Result> arrayList) {
    ...
    @NonNull
    @Override
    public NewPurchase_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.live_class_subjects_list, parent, false);
        return new NewPurchase_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final NewPurchase_Adapter.MyViewHolder holder, int position) {
        ...
        holder.subject_name_first_tv.setText(listCoupon.getSubject());
        holder.subject_name_second_tv.setText(listCoupon.getSubject());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("id", String.valueOf(listCoupon.getSubjectId()));
                bundle.putString("exam_type", String.valueOf(listCoupon.getExamId()));
                bundle.putString("subject",listCoupon.getSubject());
                ErrorMessage.I(activity, PackegeListActivity.class,bundle);
            }
        });
