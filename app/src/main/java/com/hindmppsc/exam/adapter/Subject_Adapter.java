...
public class Subject_Adapter extends RecyclerView.Adapter<Subject_Adapter.MyViewHolder> {
    ...
    public Subject_Adapter(Context policyActivity, List<Result> arrayList) {
    ...
    @NonNull
    @Override
    public Subject_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.live_class_subjects_list, parent, false);
        return new Subject_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final Subject_Adapter.MyViewHolder holder, int position) {
