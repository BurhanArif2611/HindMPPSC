...
public class Upload_Your_Self_Adapter extends RecyclerView.Adapter<Upload_Your_Self_Adapter.MyViewHolder> {
    View view;
    Context activity;
    List<Result> arrayList;


    public Upload_Your_Self_Adapter(Context policyActivity, List<Result> arrayList) {
    ...
    @NonNull
    @Override
    public Upload_Your_Self_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.live_class_subjects_list, parent, false);
        return new Upload_Your_Self_Adapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final Upload_Your_Self_Adapter.MyViewHolder holder, int position) {
        ...
        holder.right_subject_img.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_mirror));
        holder.subject_img.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_mirror));
      /*  if (listCoupon.getSubscribe().equals("subscribe")) {
        ...
        holder.join_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("title", "Upload Your Self");
